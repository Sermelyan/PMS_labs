...
void Init() {
	...
	Buttons[0] = new Button(EXTI, EXTI_FTSR_TR0, 1);
	EXTI->IMR  |= EXTI_IMR_MR0;
	Buttons[1] = new Button(EXTI, EXTI_FTSR_TR1, 2);
	EXTI->IMR  |= EXTI_IMR_MR1;
	Buttons[2] = new Button(EXTI, EXTI_FTSR_TR2, 3);
	EXTI->IMR  |= EXTI_IMR_MR2;
	Buttons[3] = new Button(EXTI, EXTI_FTSR_TR3, 4);
